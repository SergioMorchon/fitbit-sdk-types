declare module 'orientation' {
	...
	type OrientationSensor = Sensor<OrientationSensorReading, BatchedOrientationSensorReading>;
	
	type OrientationSensorConstructor = new (options?: SensorOptions) => OrientationSensor;
